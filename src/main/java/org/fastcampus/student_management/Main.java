...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    CourseQueryRepositoryImpl courseQueryRepository = new CourseQueryRepositoryImpl();
    ...
    StudentInfoDto studentInfoDto1 = new StudentInfoDto("고길동", 21, "서울시 광진구");
    ...
    CourseInfoDto courseInfoDto1 = new CourseInfoDto("첼로", 1200, "MONDAY", "고길동", 1717299008L);
